    ...
    <TooltipProvider>
      <SidebarProvider>
        ...
        <div className="min-h-screen flex w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          <Sidebar className={`border-r border-slate-950 bg-slate-950 transition-all duration-300 ${isCollapsed ? 'w-20' : 'w-64'}`}>
                        ...
                        {isCollapsed ? (
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <SidebarMenuButton 
                                asChild 
                                className={`transition-all duration-200 rounded-lg mb-1 justify-center ${
