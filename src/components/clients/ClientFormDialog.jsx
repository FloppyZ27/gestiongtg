  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={handleCloseAttempt}>
        <DialogContent className="backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-[75vw] w-[75vw] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50" style={{ marginTop: '35px', maxHeight: 'calc(100vh - 43px)' }} hideClose>
