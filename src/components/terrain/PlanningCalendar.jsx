  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog open={showMapDialog} onOpenChange={setShowMapDialog}>
        <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-[95vw] w-[95vw] p-0 gap-0" style={{ position: 'fixed', top: '120px', left: '50%', transform: 'translateX(-50%)', height: 'calc(100vh - 130px)', maxHeight: 'calc(100vh - 130px)' }}>
