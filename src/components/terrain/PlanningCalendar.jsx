    ...
    <div className="space-y-4">
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="grid grid-cols-[240px_1fr] gap-4 pt-5">
          ...
          <Card className="bg-slate-900/50 text-card-foreground rounded-xl border shadow border-slate-800 fixed left-0 top-32 w-[220px] max-h-[calc(100vh-150px)] overflow-hidden flex flex-col z-10">
