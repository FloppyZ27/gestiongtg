    ...
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          >
            <CollapsibleTrigger className="w-full py-2 px-3 hover:bg-blue-600 transition-colors bg-blue-600/90 rounded-t-lg">
          ...
          <Collapsible
            ...
            className="border border-slate-700 bg-slate-800/30 rounded-lg"
          >
            <CollapsibleTrigger className="w-full py-2 px-3 hover:bg-purple-600 transition-colors bg-purple-600/90 rounded-t-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
          ...
          <Collapsible
            ...
            className="border border-slate-700 bg-slate-800/30 rounded-lg"
          >
            <CollapsibleTrigger className="w-full py-2 px-3 hover:bg-orange-600 transition-colors bg-orange-600/90 rounded-t-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
