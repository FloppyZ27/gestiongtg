...
export default function ClientStepForm({
  ...
  const prevClientInfoSig = useRef(clientInfoSignature);
  useEffect(() => {
    if (clientInfoSignature === prevClientInfoSig.current) return;
    prevClientInfoSig.current = clientInfoSignature;
