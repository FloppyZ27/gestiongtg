              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2 mb-1 relative">
                  ...
                  <button
                    ...
                    className="absolute -top-1 -right-2 flex-shrink-0 w-5 h-5 flex items-center justify-center text-slate-600 hover:text-slate-400 transition-colors border border-slate-500 rounded"
                  >
                    <X className="w-3 h-3" />
                  </button>
                </div>
