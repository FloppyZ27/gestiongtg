  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={handleCloseAttempt}>
         <DialogContent className="backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-[75vw] w-[75vw] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50 pt-0" style={{ marginTop: '20px', maxHeight: 'calc(100vh - 80px)' }} hideClose>
           {/* Barre de progression du dossier */}
           {dossier && dossier.mandats && dossier.mandats.length > 0 && (
             <div className="px-6 pt-4 pb-2 bg-slate-900/50 border-b border-slate-800">
