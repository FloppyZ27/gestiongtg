  ...
  return (
    <>
      <Dialog open={open} modal={false} onOpenChange={(o) => {
        ...
        <DialogContent className="backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-[75vw] w-[75vw] max-h-[90vh] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50" zIndex={1100} hideClose modal={false}>
