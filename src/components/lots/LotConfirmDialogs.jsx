  ...
  return (
    <>
      ...
      <ConfirmDeleteDialog
        ...
        onOpenChange={(open) => { setShowDeleteConfirm(open); if (!open) setLotToDelete(null); }}
        onConfirm={() => { if (lotToDelete) deleteLotMutation.mutate(lotToDelete); setLotToDelete(null); }}
