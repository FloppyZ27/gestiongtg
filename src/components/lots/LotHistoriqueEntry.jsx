...
<div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-slate-500 text-xs">{log.created_date && format(new Date(log.created_date.endsWith('Z') ? log.created_date : log.created_date + 'Z'), "dd MMM yyyy 'à' HH:mm", { locale: fr })}</span>
          </div>
        </div>
      </div>
    </div>
