        ...
        return (
          <div key={idx} className="flex flex-col gap-0.5">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="bg-red-500/15 text-red-300 px-1.5 py-0.5 rounded text-[10px] line-through">{before}</span>
              <span className="text-white flex-shrink-0">→</span>
              <span className="bg-emerald-500/15 text-emerald-300 px-1.5 py-0.5 rounded text-[10px]">{after}</span>
            </div>
          </div>
        );
      }
