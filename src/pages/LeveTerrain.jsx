...
export default function LeveTerrain() {
  ...
  return (
    <TooltipProvider>
                          ...
                          <div className={`${bgColorClass} rounded-lg p-2`}>
                            ...
                            {terrain && (
                              <>
                                ...
                                {/* Temps prévu + Utilisateur assigné au mandat */}
      ...
      {showRouteMap && <RouteMapModal equipesTerrain={equipesTerrain} equipesDuJourIds={equipesDuJourIds} dossiers={dossiers} onClose={() => setShowRouteMap(false)} />}
