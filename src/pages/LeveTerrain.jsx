...
const getMandatColor = (typeMandat) => {
  const colors = { "Bornage": "bg-red-500/20 text-red-400 border-red-500/30", "Certificat de localisation": "bg-emerald-500/20 text-emerald-400 border-emerald-500/30", "Implantation": "bg-cyan-500/20 text-cyan-400 border-cyan-500/30", "OCTR": "bg-orange-500/20 text-orange-400 border-orange-500/30", "Piquetage": "bg-pink-500/20 text-pink-400 border-pink-500/30", "Projet de lotissement": "bg-teal-500/20 text-teal-400 border-teal-500/30" };
                    ...
                    >
                      ...
                      {mandat.adresse_travaux && (
                        <p className="text-slate-500 text-[10px] mt-1 truncate">
                          <MapPin className="w-2.5 h-2.5 inline mr-0.5" />{formatAdresse(mandat.adresse_travaux)}
                        </p>
                      )}
                    </button>
                  );
