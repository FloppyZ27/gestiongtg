          ...
          {user && (
            <div className="flex items-center justify-between py-4 px-6 bg-slate-900/30">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={() => { setSelectedDate(today); setSelectedItem(null); }} onMouseEnter={e => { Object.assign(e.currentTarget.style, { background: 'rgba(37,99,235,0.3)', borderColor: '#3b82f6' }); }} onMouseLeave={e => { Object.assign(e.currentTarget.style, { background: 'rgba(37,99,235,0.1)', borderColor: '#3b82f6' }); }} style={{ background: 'rgba(37,99,235,0.1)', border: '1px solid #3b82f6', color: '#60a5fa', padding: '0 12px', height: '32px', borderRadius: '6px', display: 'inline-flex', alignItems: 'center', cursor: 'pointer', fontSize: '14px', fontWeight: '500', transition: 'background 0.15s' }}>Aujourd'hui</button>
              </div>
