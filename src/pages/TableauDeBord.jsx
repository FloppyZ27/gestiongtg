    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4 md:p-8">
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[25%_50%_25%] gap-6 mb-6">
          ...
          <Card className={`border-slate-800 bg-slate-900/50 backdrop-blur-xl shadow-xl mr-[70px] ${hasAnniversaireAujourdhui ? 'ring-2 ring-pink-500 shadow-pink-500/50 shadow-2xl' : ''}`}>
