        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Dialog open={isDialogOpen} onOpenChange={(open) => {
              ...
              <DialogContent className="backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-[75vw] w-[75vw] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50" style={{ marginTop: '10px', maxHeight: 'calc(90vh - 20px)' }} hideClose>
                <EditDossierForm
                  formData={formData}
