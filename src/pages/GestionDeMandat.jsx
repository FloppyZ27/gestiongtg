              ...
              <Card className="!border-0 !shadow-none bg-slate-900/50 backdrop-blur-xl">
                <CardHeader className="border-b border-slate-800">
                  <div className="flex justify-between items-center gap-2">
                    ...
                    <div className="flex gap-1">
                      <button onClick={() => { setCalendarMode("week"); setCurrentMonthStart(startOfWeek(new Date(), { weekStartsOn: 1 })); }} className={`timesheet-tab-button px-4 py-1.5 text-sm font-medium transition-all rounded ${calendarMode === "week" ? "bg-blue-600 text-white shadow-lg" : "bg-slate-800 text-white hover:bg-blue-600/20"}`}>Semaine</button>
                      <button onClick={() => { setCalendarMode("month"); setCurrentMonthStart(startOfMonth(new Date())); }} className={`timesheet-tab-button px-4 py-1.5 text-sm font-medium transition-all rounded ${calendarMode === "month" ? "bg-blue-600 text-white shadow-lg" : "bg-slate-800 text-white hover:bg-blue-600/20"}`}>Mois</button>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-4">
