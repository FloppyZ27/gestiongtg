...
const getArpenteurColor = (arpenteur) => {
  const colors = {
    "Samuel Guay": "bg-red-500/10 text-red-400",
    "Pierre-Luc Pilote": "bg-slate-300/20 text-slate-200",
    "Frédéric Gilbert": "bg-orange-500/10 text-orange-400",
    "Dany Gaboury": "bg-yellow-500/10 text-yellow-400",
    "Benjamin Larouche": "bg-cyan-500/10 text-cyan-400"
  };
  return colors[arpenteur] || "bg-emerald-500/10 text-emerald-400";
};
