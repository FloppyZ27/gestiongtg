      ...
      <div className="w-full">
        <div className="pb-4 pt-4">
          <div className="flex items-center gap-3 mb-2">
            ...
            <Kanban className="w-6 h-6 text-red-500" style={{ background: 'linear-gradient(90deg, #ef4444, #f97316)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent', color: 'transparent', filter: 'drop-shadow(0 0 2px rgba(239, 68, 68, 0.8))' }} />
          </div>
