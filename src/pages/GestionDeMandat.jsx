                ...
                <CardHeader className="border-b border-slate-800 bg-transparent">
                  <div className="flex justify-between items-center gap-2">
                    ...
                    <div className="flex items-center gap-3">
                         ...
                         <Button size="sm" onClick={() => setCurrentMonthStart(calendarMode === "week" ? startOfWeek(new Date(), { weekStartsOn: 1 }) : startOfMonth(new Date()))} className="bg-primary/20 text-primary border border-primary/30 transition-all duration-200 hover:bg-primary/40 hover:scale-105">Aujourd'hui</Button>
                         </div>
