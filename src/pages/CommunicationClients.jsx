      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="flex items-center gap-2 mb-2">
            <TabsList className="bg-slate-800/50 h-12 w-1/2 flex items-center justify-between px-2">
              <TabsTrigger 
                value="prise-mandat" 
              ...
              <Button 
                ...
                size="sm"
                className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white shadow-lg shadow-emerald-500/50 ml-2"
              >
            ...
            <TabsList className="bg-slate-800/50 h-12 w-1/2 flex items-center justify-between px-2">
              <TabsTrigger 
                value="retours-appel" 
                className="text-sm data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400 data-[state=active]:border-b-2 data-[state=active]:border-blue-400 flex items-center gap-2 flex-1 relative"
              >
              ...
              <Button 
                ...
                size="sm"
                className="bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white shadow-lg shadow-blue-500/50 ml-2"
              >
                <Plus className="w-4 h-4" />
              </Button>
            </TabsList>
