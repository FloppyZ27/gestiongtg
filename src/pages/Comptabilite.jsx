        ...
        <div className="w-full">
          <div className="mb-8">
            <div className="flex items-center gap-3">
              <h1 className="text-3xl md:text-4xl font-bold text-primary">Comptabilité</h1>
          ...
          <Dialog open={isNotesFacturesOpen} onOpenChange={setIsNotesFacturesOpen}>
            <DialogContent className="bg-slate-900 border-slate-800 text-white max-w-2xl">
              ...
              <Tabs defaultValue="note" className="w-full" onValueChange={(v) => setNotesFacturesTab(v)}>
                <TabsList className="grid w-full grid-cols-2 bg-slate-800/50 h-12">
                  <TabsTrigger value="note" className="data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary text-slate-400 h-full">Note</TabsTrigger>
                  <TabsTrigger value="factures" className="flex items-center gap-2 data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=active]:border-b-2 data-[state=active]:border-primary text-slate-400 h-full">
                    Factures
            ...
            {!mandatsCollapsed && (
              <CardContent className="p-4">
                ...
                <div className="flex items-center justify-between mb-3 p-3 rounded-lg">
                  <div className="flex items-center gap-2">
                    <span className="text-white font-semibold">{selectedArpenteur} ({mandatsItems.length} mandat{mandatsItems.length > 1 ? 's' : ''})</span>
                  </div>
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                  ...
                  <div className="overflow-hidden">
                    ...
                    {mandatsItems.map(({ dossier, mandat }, idx) => {
                      ...
                      return (
                        <div
                          key={`${dossier.id}-${idx}`}
                          className="grid grid-cols-[1.2fr,2fr,1.5fr,2fr,1fr,1.8fr] px-3 py-2 border-b border-slate-800 hover:bg-slate-800/30 transition-colors items-center gap-2 cursor-pointer"
                          onClick={() => window.dispatchEvent(new CustomEvent('openDossierEdit', { detail: { dossierId: dossier.id } }))}
                        >
                          <div>
