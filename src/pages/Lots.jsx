...
import NewLotModal from "@/components/lots/NewLotModal";
      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Button onClick={() => {
              if (!isFormDialogOpen && hasFormChanges && !editingLot) {
                setShowCancelConfirm(true);
                return;
              }
              setIsFormDialogOpen(true);
            }} className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 transition-all text-white shadow-lg">
