      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <Dialog open={isDialogOpen} onOpenChange={async (open) => {
            ...
            <DialogContent className="backdrop-blur-sm border-2 border-white/30 text-white max-w-[75vw] w-[75vw] max-h-[90vh] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50" hideClose>
          ...
          <Dialog open={isOuvrirDossierDialogOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="backdrop-blur-sm border-2 border-white/30 text-white max-w-[75vw] w-[75vw] max-h-[90vh] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50">
              <DialogHeader className="sr-only">
        ...
        <Dialog open={showStatutChangeConfirm} onOpenChange={setShowStatutChangeConfirm}>
          <DialogContent className="backdrop-blur-sm border-2 border-white/30 text-white max-w-md shadow-2xl shadow-black/50">
            <DialogHeader>
        ...
        <Dialog open={isClientSelectorOpen} onOpenChange={setIsClientSelectorOpen}>
          <DialogContent className="backdrop-blur-sm border-2 border-white/30 text-white max-w-4xl shadow-2xl shadow-black/50" hideClose>
            <DialogHeader>
        ...
        <Dialog open={!!viewingClientDetails} onOpenChange={(open) => !open && setViewingClientDetails(null)}>
          <DialogContent className="backdrop-blur-sm border-2 border-white/30 text-white max-w-[95vw] w-[95vw] h-[90vh] max-h-[90vh] p-0 gap-0 overflow-hidden flex flex-col shadow-2xl shadow-black/50">
        ...
        <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
          <DialogContent className="backdrop-blur-sm border-2 border-white/30 text-white max-w-[95vw] w-[95vw] max-h-[90vh] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50">
            <DialogHeader className="sr-only">
