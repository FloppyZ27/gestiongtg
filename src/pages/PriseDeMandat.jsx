              ...
              >
                ...
                <div className="flex-[0_0_70%] flex flex-col border-r border-slate-800">
                  ...
                  <div className="flex justify-end gap-3 p-4 bg-slate-900 border-t border-slate-800 flex-shrink-0">
                    <Button type="button" variant="ghost" className="text-red-400 hover:bg-red-500/10" onClick={async () => {
                      const hasData = formData.arpenteur_geometre || 
                        formData.clients_ids.length > 0 ||
                        clientInfo.prenom || clientInfo.nom || clientInfo.telephone || clientInfo.courriel ||
                        workAddress.rue || workAddress.ville || workAddress.numeros_civiques?.[0] ||
              ...
              >
                <div className="flex-[0_0_70%] overflow-y-auto p-6 border-r border-slate-800">
                  ...
                  <div className="flex justify-end gap-3 pt-4 sticky bottom-0 bg-slate-900/95 backdrop-blur py-4 border-t border-slate-800 px-6">
                    <Button type="button" variant="ghost" className="text-red-400 hover:bg-red-500/10" onClick={() => {
                      const initialMandats = mandatsInfo.filter(m => m.type_mandat).map(m => ({
                        type_mandat: m.type_mandat,
                        date_livraison: m.date_livraison || ""
                      }));
          ...
          <DialogContent className="backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-md shadow-2xl shadow-black/50">
            ...
            >
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-800">
                <Button type="button" variant="ghost" onClick={() => setIsAddMinuteDialogOpen(false)} className="text-red-400 hover:bg-red-500/10">
                  Annuler
                </Button>
                <Button
                  type="button"
          ...
          <DialogContent className="backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-[75vw] w-[75vw] max-h-[90vh] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50">
            ...
            >
              ...
              <div className="flex-[0_0_70%] flex flex-col border-r border-slate-800">
                ...
                {/* Boutons en bas */}
                <div className="flex justify-end gap-3 p-4 bg-slate-900 border-t border-slate-800 flex-shrink-0">
                <Button type="button" variant="ghost" onClick={() => setIsNewLotDialogOpen(false)} className="text-red-400 hover:bg-red-500/10">
                  Annuler
                </Button>
              ...
              >
                ...
                <div className="flex-[0_0_70%] overflow-y-auto p-6 border-r border-slate-800">
                  ...
                  <div className="flex justify-end gap-3 pt-6 sticky bottom-0 bg-slate-900/95 backdrop-blur py-4 border-t border-slate-800">
                    <Button type="button" variant="ghost" onClick={() => setIsViewDialogOpen(false)} className="text-red-400 hover:bg-red-500/10">
                      Fermer
                    </Button>
