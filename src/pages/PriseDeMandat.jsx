      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <Dialog open={isDialogOpen} onOpenChange={async (open) => {
            ...
            <DialogContent className={`backdrop-blur-[0.5px] border-2 border-white/30 text-white max-w-[75vw] w-[75vw] max-h-[90vh] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50 ${isOuvrirDossierDialogOpen ? 'opacity-0 pointer-events-none' : ''}`} hideClose>
                ...
                <div className="flex-[0_0_70%] flex flex-col border-r border-slate-800">
                  ...
                  <div className="mb-6 flex items-center justify-between">
                    ...
                    {formData.statut === "Mandats à ouvrir" && (
                      <Button
                        type="button"
                        className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-purple-400 border-2 border-purple-500"
                        onClick={() => {
