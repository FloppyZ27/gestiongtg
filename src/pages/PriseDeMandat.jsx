...
import PriseMandatNavSidebar from "../components/mandat/PriseMandatNavSidebar"; import ConfirmationDialogs from "../components/mandat/ConfirmationDialogs";
import PriseMandatSidebar from "../components/mandat/PriseMandatSidebar";
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <Dialog open={isOuvrirDossierDialogOpen} onOpenChange={(open) => {
            if (!open) {
              ...
              editingPriseMandat={editingPriseMandat} isLocked={isLocked} setIsDialogOpen={setIsDialogOpen}
              resetFullForm={resetFullForm} setIsLocked={setIsLocked} setLockedBy={setLockedBy}
              showUnsavedWarning={showUnsavedWarning} setShowUnsavedWarning={setShowUnsavedWarning}
              showCancelConfirmDossier={showCancelConfirmDossier} setShowCancelConfirmDossier={setShowCancelConfirmDossier}
              ...
              setDossierDocuments={setDossierDocuments} setActiveTabMandatDossier={setActiveTabMandatDossier}
              showDeleteMandatConfirm={showDeleteMandatConfirm} setShowDeleteMandatConfirm={setShowDeleteMandatConfirm}
              mandatIndexToDelete={mandatIndexToDelete} setMandatIndexToDelete={setMandatIndexToDelete}
              nouveauDossierForm={nouveauDossierForm}
              ...
              showDeleteConcordanceConfirm={showDeleteConcordanceConfirm} setShowDeleteConcordanceConfirm={setShowDeleteConcordanceConfirm}
              concordanceIndexToDelete={concordanceIndexToDelete} setConcordanceIndexToDelete={setConcordanceIndexToDelete}
              setNewLotForm={setNewLotForm}
              showCancelLotConfirm={showCancelLotConfirm} setShowCancelLotConfirm={setShowCancelLotConfirm}
              setIsNewLotDialogOpen={setIsNewLotDialogOpen} resetLotForm={resetLotForm}
              ...
              showDeletePriseMandatConfirm={showDeletePriseMandatConfirm} setShowDeletePriseMandatConfirm={setShowDeletePriseMandatConfirm}
              priseMandatIdToDelete={priseMandatIdToDelete} setPriseMandatIdToDelete={setPriseMandatIdToDelete}
              deletePriseMandatMutation={deletePriseMandatMutation}
