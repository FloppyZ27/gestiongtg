      ...
      <div className="w-full">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <Dialog open={isDialogOpen} onOpenChange={async (open) => {
            ...
            <DialogContent className={`border-0 text-white max-w-[75vw] w-[75vw] p-0 gap-0 overflow-hidden shadow-2xl shadow-black/50`} style={{ marginTop: '19px', maxHeight: 'calc(90vh - 5px)' }}>
